...
function BrandIcon({ d, size, className }: { d: string; size?: number; className?: string }) {
  const s = size ?? 16;
  return (
    <svg
      viewBox="0 0 24 24"
...
export function XIcon({ size, className }: BrandIconProps) {
  return <BrandIcon d={X_PATH} size={size} className={className} />;
}
export function GithubIcon({ size, className }: BrandIconProps) {
  return <BrandIcon d={GITHUB_PATH} size={size} className={className} />;
}
export function GitlabIcon({ size, className }: BrandIconProps) {
  return <BrandIcon d={GITLAB_PATH} size={size} className={className} />;
}
export function RedditIcon({ size, className }: BrandIconProps) {
  return <BrandIcon d={REDDIT_PATH} size={size} className={className} />;
}
